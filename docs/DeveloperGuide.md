...
6. Right-to-left (RTL) text is not currently supported. This is reasonable given the application's target market in Singapore, where RTL languages are less commonly used.
